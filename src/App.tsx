        ...
        <div className="content">
          ...
          <div className="text_area" id="text_area">
            <h1 className="about_me_title" id="about_me_title">
              Hi, My Name's Guilherme Henrique
            </h1>
            <p className="about_me_text" id="about_me_text">
              ...
              Something that I like too is to explain things to someone, I
              Really like it. Everyday Studying, learning something else and
              helping people around !
            </p>
            <br />
            <small className="phrase">
            ...
            <a
              id="linkedin"
              title="Linkedin"
              href="https://www.linkedin.com/in/guilherme-henrique-0bb264204/"
            >
              <svg
                stroke="currentColor"
                fill="blue"
            ...
            <a
              id="github"
              title="GitHub"
              href="https://github.com/Guilherme2014-ai"
            >
              <svg
            ...
            <a
              id="whats"
              title="WhatsApp"
              href="https://api.whatsapp.com/send?phone=5515988315201&amp;text=Ol%C3%A1%2C%20envie%20sua%20mensagem%2C%20logo%20irei%20responder."
            >
              <svg
                stroke="currentColor"
                fill="green"
